  ...
  if (!isConnected) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-gray-400">Connect your wallet to post a job.</p>
      </div>
    );
  }
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:border-indigo-500 focus:outline-none"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:border-indigo-500 focus:outline-none resize-none"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:border-indigo-500 focus:outline-none"
          >
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 text-indigo-400 hover:text-indigo-300 text-sm disabled:opacity-50"
            >
            ...
            <div key={i} className="bg-gray-900 border border-gray-800 rounded-lg p-4 space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-500 focus:border-indigo-500 focus:outline-none pr-16"
                />
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 space-y-2">
          ...
          <div className="border-t border-gray-700 pt-2 flex justify-between text-sm font-semibold">
            ...
            <span className="text-indigo-400">{totalRequired.toFixed(2)} USDC</span>
          </div>
        </div>
        ...
        >
          {isPending ? "Confirm in Wallet..." : isConfirming ? "Creating Job..." : "Create Job & Lock USDC"}
        </button>
